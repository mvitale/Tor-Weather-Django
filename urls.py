...
urlpatterns = patterns('weather.weatherapp.views',
    ...
    (r'^confirm/(?P<confirm_auth>[a-zA-Z0-9]+)/$', 'confirm'),
    (r'^unsubscribe/(?P<unsubscribe_auth>[a-zA-Z0-9]+)/$','unsubscribe'),
    (r'^preferences/(?P<pref_auth>[a-zA-Z0-9]+)/$','preferences'),
    (r'^confirm_pref/(?P<pref_auth>[a-zA-Z0-9]+)/$','confirm_pref'),
